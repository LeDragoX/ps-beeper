Import-Module $PSScriptRoot\..\lib\"Start-Beep.psm1" -Function Read-Glossary, Start-Beep -PassThru -Force
Import-Module $PSScriptRoot\..\lib\"Translate-ToFrequency.psm1" -Function * -PassThru -Force
